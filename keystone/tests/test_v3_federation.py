...
class FederatedTokenTests(FederationTests):
    ...
    def test_issue_token_with_nonexistent_group(self):
        ...
        backend and raise exception.UnexpectedError exception.
    ...
    def test_workflow_with_groups_deletion(self):
        ...
        # scope token to project_all, expect HTTP 401
        ...
        # revert to old mapping
        self.federation_api.update_mapping(self.mapping['id'],
                                           self.rules)
